...
<div>
<scan class="quiz-question">¿Cuál es la principal diferencia operativa entre un compilador y un intérprete?</scan>
...
<div class="quiz-feedback" 
     data-correct-explain=" El compilador realiza la traducción de forma previa (offline), mientras que el intérprete procesa el código fuente directamente en caliente." 
